...
def import_weights_to_mysql(database: str, table: str, cfg_path: str = DEFAULT_DB_CONFIG):
    ...
    a_folder = cfg.get('a_folder') or A_FOLDER
...
def main(database: str, table: str):
    ...
    try:
            import_weights_to_mysql(database=database, table=table)
